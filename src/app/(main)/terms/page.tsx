  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="mb-3 text-xl font-semibold text-gray-900">제2조 (정의)</h2>
        ...
        <section>
          <h2 className="mb-3 text-xl font-semibold text-gray-900">제4조 (사용자 의무)</h2>
          <ol className="list-decimal space-y-2 pl-6">
            <li>
        ...
        <section>
          <h2 className="mb-3 text-xl font-semibold text-gray-900">제5조 (지적 재산권)</h2>
          <ol className="list-decimal space-y-2 pl-6">
        ...
        <section>
          <h2 className="mb-3 text-xl font-semibold text-gray-900">제6조 (면책 조항)</h2>
          <ol className="list-decimal space-y-2 pl-6">
