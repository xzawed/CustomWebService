      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg bg-gray-900 px-4 py-3 text-sm font-medium text-white shadow-sm transition-all hover:bg-gray-800 hover:shadow-md"
          >
