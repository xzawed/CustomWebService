      ...
      <div className="glass relative w-full max-w-sm rounded-2xl p-8">
        ...
        <div className="space-y-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl px-4 py-3.5 text-sm font-semibold text-white transition-all hover:shadow-lg"
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl bg-white px-4 py-3.5 text-sm font-semibold text-gray-900 transition-all hover:bg-gray-100 hover:shadow-lg"
          >
        ...
        <p className="mt-6 text-center text-[11px] text-slate-500">
          로그인하면 <span className="text-slate-400 underline">이용약관</span>에 동의하는 것으로 간주됩니다.
        </p>
      </div>
    </div>
  );
