...
**S0 완료 조건:**
- [ ] 미리보기 iframe이 대시보드에서 정상 표시됨
- [ ] 빌드 에러 없음
- [ ] 기존 기능 회귀 없음 (로그인, 생성, 미리보기)
...
**S4 완료 조건:**
- [ ] 대시보드에서 `generated` 프로젝트에 "게시" 버튼 노출
- [ ] "게시" 클릭 → 즉시 slug URL 표시
- [ ] slug URL 옆 "복사" 클릭 → 클립보드에 전체 URL 복사
- [ ] "게시 취소" 클릭 → 상태 변경, URL 숨김
- [ ] 새로고침 후 상태 유지
