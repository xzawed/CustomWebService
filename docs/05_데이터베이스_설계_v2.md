...
```json
{
  "maxProjects": 50,
  "maxMembersCount": 5,
  "allowedDeployPlatforms": ["vercel", "github_pages"],
...
```json
{
  ...
  "deployHistory": [
    { "version": 1, "deployedAt": "...", "platform": "vercel", "url": "..." }
  ]
}
```
...
CREATE TABLE generated_codes (
    ...
    ai_prompt_used TEXT,
    -- ★ 확장성 컬럼
    ai_provider VARCHAR(30),                  -- gemini, openai, ollama
    ai_model VARCHAR(50),                     -- gemini-1.5-flash, gpt-4o-mini
