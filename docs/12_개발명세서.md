...
// 5. 환경변수 설정 (API 키)
// 6. 배포 플랫폼 연동
//    - Railway: Railway API로 프로젝트 생성 & 배포
...
// 3. assembleHtml()로 HTML + CSS + JS를 완성된 HTML로 조합
// 4. Content-Type: text/html; charset=utf-8로 반환
```

### 5.7 `src/app/api/v1/projects/[id]/rollback/route.ts` ✅ 구현 완료
```typescript
