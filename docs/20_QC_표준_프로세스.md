...
### Stage 4: 이슈 판단 → 자동 재생성 (1회)

아래 조건 중 하나라도 해당하면 자동 재생성:

| 조건 | 임계값 |
|------|--------|
| 구조 점수 미달 | structuralScore < 40 |
| 모바일 점수 미달 | mobileScore < 40 |
