...
- **Anthropic 모델 ID 주의**: 날짜 suffix 없으면 API 실패 — 반드시 `claude-haiku-4-5-20251001`, `claude-sonnet-4-6`, `claude-opus-4-6` 형태 사용
...
**규칙:** 새 문서 추가·수정·삭제 시 이 파일의 "문서 참조" 테이블도 함께 업데이트
